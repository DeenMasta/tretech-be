...
#[Fillable(['reconciliation_id', 'lot_id', 'instrument_set_id', 'product_id', 'result', 'remarks', 'quantity', 'used_quantity', 'returned_quantity', 'damaged_quantity', 'missing_quantity'])]
